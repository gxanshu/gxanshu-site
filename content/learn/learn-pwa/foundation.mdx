---
title: Foundation
description: All Progressive Web Apps are, at their core, modern websites, so it's important that your website has a solid foundation in responsive design, mobile and everything first, intrinsic design, and web performance.
date: 2021-08-19
slug: foundation
category: learn
list: 9
...
#### Avoid device detection [#](#avoid-device-detection)
...
During the past decade, we've been dealing with different metrics to measure success in web performance. Today, a set of recommended metrics are grouped under the project [Web Vitals](https://web.dev/vitals/). Web Vitals focus metrics in three key areas affecting web performance and perception:

-   Loading
-   Interactive
-   Visual Stability

[A set of metrics from Core Web Vitals showing a website's performance results.](https://web-dev.imgix.net/image/RK2djpBgopg9kzCyJbUSjhEGmnw1/gu948vCUtGMKb6dKcSpZ.png?auto=format)
