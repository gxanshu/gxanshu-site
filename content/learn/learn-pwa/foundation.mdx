...
During the past decade, we've been dealing with different metrics to measure success in web performance. Today, a set of recommended metrics are grouped under the project [Web Vitals](/vitals/). Web Vitals focus metrics in three key areas affecting web performance and perception:
